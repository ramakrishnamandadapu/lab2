In order to run the examples simply execute one of the gradle tasks pollSeviceServer,pollServiceClient, routeGuideServer,routeGuideClient, helloWorldServer, or helloWorldClient.
